...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    ...
    var pizzaSelectionAtOnce = document.querySelectorAll(".randomPizzaContainer");
    for (var i = 0; i < pizzaSelectionAtOnce.length; i++) {
      pizzaSelectionAtOnce[i].style.width = newWidth + "%"
    }
  }
